...
function Swap() {
  ...
  const walletBalance = balanceData && decimalsData
  ...
  const canContinue = isAmountValid && isConnected && !isLoading && !isOverBalance
  ...
  async function handleContinue() {
    ...
    try {
      ...
      await switchChainAsync({ chainId: FROM_CHAIN_ID })
      ...
      await writeContractAsync({
        ...
        args: [fundAddress, parseUnits(fundAmount, decimals)],
        chainId: FROM_CHAIN_ID,
      })
    } catch (e) {
  ...
  useEffect(() => {
    if (!amount || amount === '0' || !isConnected) return
